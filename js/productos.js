...
const products = [
    ...
    { id: 6, name: "Infinix Note 40 pro Dual Sim", category: "Smartphones", price: "$4,500 MXN", img: "./src/img/productos/img_Eli(celulares)/INFINIX.jpeg" },
    { id: 7, name: "OPPO Reno 11 5G Dual SIM", category: "Smartphones", price: "$7,000 MXN", img: "./src/img/productos/img_Eli(celulares)/OPPO.jpeg" },
    { id: 8, name: "Motorola Edge 50 Fusión", category: "Smartphones", price: "$7,500 MXN", img: "./src/img/productos/img_Eli(celulares)/MOTOROLA.jpeg" },
    { id: 9, name: "Xiaomi Redmi Note 13 pro+ 5G Dual SIM", category: "Smartphones", price: "$6,900 MXN", img: "./src/img/productos/img_Eli(celulares)/REDMI.jpeg" },
    { id: 10, name: "Xiaomi Poco F6 Pro 5G ", category: "Smartwatch", price: "$2,899 MXN", img: "./src/img/productos/img_Eli(celulares)/POCCO.jpeg" },
    ...
    { id: 50, name: "Xiaomi Pad 6", category: "Tablets", price: "$8,000 MXN", img: "./src/img/productos/50.jpg" },
